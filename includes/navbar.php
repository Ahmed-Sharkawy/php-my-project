...
<div id="offer" style="padding:3px;">
    <h4 style="text-align:center">ONLINE SERVICES STORE</h4>
</div>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown messages-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
               <!--<i class="fa fa-shopping-cart alink" style='color:#fff;font-size: 25px;margin:7px 0px'></i> -->
              <span style='color:#fff;font-size: 25px;margin:7px 0px'>RQ</span>
